...
for (x, y, w, h) in faces:
    ...
    for _ in range(54):
        recog = cv2.createLBPHFaceRecognizer(radPix)     # creating EIGEN FACE RECOGNISER
    ...
    nei_conf = []
    for _ in range(13):
        recog = cv2.createLBPHFaceRecognizer(radPixel, neighbour)  # creating FACE RECOGNISER
    ...
    cell_conf = []
    for _ in range(50):
        recog = cv2.createLBPHFaceRecognizer(radPixel, neighbour, cellVal, cellVal)  # creating FACE RECOGNISER
